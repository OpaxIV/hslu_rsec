...
def main():
    ...
    while True:
        ...
        """         (xView, yView) = transform(currentFocus[2],currentFocus[1])
        print(xView,yView)
        view_of_canvas = canvas[int(xView-canvas_maxx/2+1),int(xView+canvas_maxx/2-1)][int(yView-canvas_maxy/2+1),int(yView+canvas_maxy/2-1)]
